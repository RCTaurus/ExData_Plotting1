...
#Display the historam on the active device : png here
hist(selectdata$Global_active_power, col="red", xlab="Global Active Power (killowatts)", main="Global Active Power")

#Shutoff the device png file here
dev.off()
